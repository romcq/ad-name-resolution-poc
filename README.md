...
| 55 | Корнер Kerberos AS-REQ: fallback из account name в UPN | NT-PRINCIPAL/userPrincipalName | Kerberos: AS-REQ / Client Principal Lookup | `krb_as_principal_upn_fallback` |
